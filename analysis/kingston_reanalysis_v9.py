# -*- coding: utf-8 -*-
"""
KINGSTON v9 重分析 (回应第六轮逐句评审, 2026-09-24)
...
REPO_DATA = 'C:/Users/admin/WorkBuddy/2026-07-05-05-44-50/github_kingston_vendor_csa/data/'
R = {}

# Override BASE / REPO_DATA when running inside the public repository (env var)
_BASE_ENV = os.environ.get('KINGSTON_INTERNAL_DIR')
if _BASE_ENV:
    BASE = _BASE_ENV
    # REPO_DATA points to data/ inside the repo itself
    REPO_DATA = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'data')
if not os.path.exists(REPO_DATA + os.sep):  # ensure trailing separator
    REPO_DATA = REPO_DATA + os.sep
...
if HAVE_INTERNAL:
    ...
    _t3_n, _t3_age_mean, _t3_age_sd = 14, 46.5, 8.5
    _t3_all_ge = True
...
# ============ 保存 ============
out = 'C:/Users/admin/WorkBuddy/2026-07-05-05-44-50/reanalysis_v9_results.json'
